...
<td>
<a href="/dailyMoldingWork/main?action=update&id=<%=String.valueOf(p.getId()) %>" class="btn btn-primary">更新</a>
<a href="/dailyMoldingWork/Ingestiondata?action=delete&id=<%=String.valueOf(p.getId()) %>" class="btn btn-danger" onclick="return confirm('削除してよろしいですか？');">削除</a>
<a href="/dailyMoldingWork/Ingestiondata?action=download&id=<%=String.valueOf(p.getId()) %>" class="btn btn-success" onclick="return confirm('ダウンロードしてよろしいですか？');">CSV</a>
</td>
</tr>
