...
private void getConnection() throws NamingException, SQLException{
	...
	public boolean insertOne(Product product){
		try {
			...
			ps.setFloat(36, product.getWorkmantime_R());
			ps.setFloat(37, product.getMachinetime_R());
			ps.setInt(38,product.getArrangementnumber_R());
			ps.setInt(39, product.getNumbernodefectiveproducts_R());
			ps.setInt(40, product.getTotalnumberdefects_R());
			ps.setString(41, product.getDefectclassificationcode1_R());
			ps.setInt(42, product.getNumberdefects1_R());
			ps.setString(43, product.getDefectclassificationcode2_R());
			ps.setInt(44, product.getNumberdefects2_R());
			ps.setString(45, product.getDefectclassificationcode3_R());
			ps.setInt(46, product.getNumberdefects3_R());
			ps.setString(47, product.getDefectclassificationcode4_R());
			ps.setString(48, product.getNumberdefects4_R());
			ps.setString(49, product.getDefectclassificationcode5_R());
			ps.setString(50, product.getNumberdefects5_R());
			ps.setString(51, product.getDefectclassificationcode6_R());
			ps.setString(52, product.getNumberdefects6_R());
			ps.setString(53, product.getDefectclassificationcode7_R());
			ps.setString(54, product.getNumberdefects7_R());
			ps.setString(55, product.getDefectclassificationcode8_R());
			ps.setString(56, product.getNumberdefects8_R());
			ps.setString(57, product.getDefectclassificationcode9_R());
			ps.setString(58, product.getNumberdefects9_R());
			ps.setString(59, product.getSparepartnumber1_R());
			ps.setString(60, product.getSparepartnumber2_R());
			ps.setString(61, product.getSparepartnumber3_R());
			ps.setString(62, product.getSparenumberdefects1_R());
			ps.setString(63, product.getSparenumberdefects2_R());
			ps.setString(64, product.getSparenumberdefects3_R());
	...
	public Product downloadOne_R(int id){
		...
		try{
			...
			if(rs.next()){
				...
				//csvのファイル名
				String fileName = generateFileName(rs.getString("workperformancedate"),rs.getInt("arrangementnumber_R"),rs.getString("machinecode"),rs.getString("workinghours"));
				PrintWriter csvWriter = new PrintWriter("/var/samba/Data_Transfer/DailyMoldingWork_tomcat/"+ fileName, "Shift-JIS");
